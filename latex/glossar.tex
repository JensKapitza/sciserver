...
{Verschlüsselung durch Zertifikate, häufige Verwendung bei HTTPS, SMTPS, FTPS und sollte nicht mit SFTP verwechselt werden, welches ein anderes Verfahren nutzt (Schlagwort: SSH).} % description
...
{Lebenszeit, z.bB. für ein Verwerfen eines Paketes im Netzwerk.} % description
...
{Absoluter vollständiger Domainname eines Computers.} % description
 ...
 {Spezielle Form eines Clients, der voll vom Anwendungsserver abhängig ist.} % description
